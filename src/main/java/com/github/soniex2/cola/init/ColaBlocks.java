...
import com.github.soniex2.cola.block.BlockColaFurnace;
...
public class ColaBlocks {
    ...
    public static final BlockColaFurnace cola_furnace = new BlockColaFurnace(Material.iron);
    ...
    public static void init() {
        ...
        GameRegistry.registerBlock(cola_furnace, "cola_furnace");
    }
}
